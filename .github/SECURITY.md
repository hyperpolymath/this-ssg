...
Replace all {{PLACEHOLDER}} values with your information:
  this-ssg     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  this-ssg             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/this-ssg/security/advisories/new)
...
- This repository (`hyperpolymath/this-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/this-ssg/security/advisories)
...
When using this-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/this-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/this-ssg/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/this-ssg/discussions) |
...
*Thank you for helping keep this-ssg and its users safe.* 🛡️
